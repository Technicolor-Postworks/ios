...
@objc class NCBrandOptions: NSObject {
    ...
    @objc public var textCopyrightNextcloudiOS:         String = "Postcloud Liquid for iOS %@ © 2021"
    @objc public var textCopyrightNextcloudServer:      String = "Postcloud Server %@"
    ...
    // Capabilities Group
    @objc public var capabilitiesGroups:                String = "group.com.postworks.postcloud"
...
class NCBrandColor: NSObject {
    ...
    // Color
    @objc public let customer:              UIColor = UIColor(red: 0.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)    // BLU NC : #0082c9
    ...
    @objc public let nextcloud:             UIColor = UIColor(red: 0.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)
